    ...
    return (
        <div className={classes.centerDivs}>
         <Card >
            ...
            <TextField id="outlined-basic" label="Enter Email" type="email" value={email} onChange={(e)=>{setEmail(e.target.value)}} variant="outlined" />
            <TextField id="outlined-basic" label="Enter Password" type="password" value={password} onChange={(e)=>{setPassword(e.target.value)}} variant="outlined" />
            <TextField id="outlined-basic" label="Full Name" type="text" value={username} onChange={(e)=>{setUserName(e.target.value)}} variant="outlined" />
            <UploadComponent></UploadComponent>

            </CardContent>
            <Card>
            <Button variant="contained" className={classes.fullwidth} color="primary">SIGN UP</Button>
             <CardContent>
                <Typography>
            ...
            <Card variant="outlined">
                ...
                Hava an account?
                <LinkButton content="Log In" route="/login"></LinkButton>
                </Typography>
                    </Card>
