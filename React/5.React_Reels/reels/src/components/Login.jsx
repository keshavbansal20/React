...
import {Typography ,Button ,CardActions ,makeStyles ,CardContent, Container ,TextField, Grid , Paper , Card , CardMedia} from '@material-ui/core';
                    ...
                    <Grid item sm={5}>
                        <Card variant="outlined">
                            ...
                            <CardContent className={classes.centerElements}>
                                <TextField id="outlined=basic" label="email" type="email" type="email"  variant="outlined" size="small" display="block" value={email}
                                className={classes.mb}
                                 onChange={(e)=>{setEmail(e.target.value)}}
                                />
                                <TextField id="oulined-basic" label="password" type="password" variant="outlined"
                                    size="small"
                                    className={classes.mb}
