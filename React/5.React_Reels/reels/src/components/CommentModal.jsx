...
import { makeStyles, Grid, Avatar, Typography, IconButton, Hidden, Icon } from '@material-ui/core';
...
function CommentModal({commentVideoObj , postComments , setCommentVideoObj ,setLoading}) {
        ...
        <Grid container className = {classes.mainContainer}>
            ...
            <Grid  item xs={10} sm={8} md={4} lg={3} className={classes.commentSection}>
                <div className = {classes.commentSectionHeader}>
                    ...
                    <Typography variant="subtitle1" className={classes.profileName}>me_keshavbansal</Typography>
                    </div>
